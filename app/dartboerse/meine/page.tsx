...
export default function MeineDartboersePage(){
 ...
 return <div className="min-h-screen bg-slate-50 pb-24"><Header/><main className="mx-auto max-w-6xl px-4 pt-20"><div className="mb-4"><Button asChild variant="ghost" className="-ml-2 rounded-xl text-slate-600 hover:bg-white hover:text-slate-950"><Link href="/dartboerse"><ArrowLeft className="mr-2 h-4 w-4"/>Zur Dartbörse</Link></Button></div><section className="rounded-[2rem] bg-gradient-to-br from-slate-950 to-orange-950 p-6 text-white shadow-2xl sm:p-8"><div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><div className="text-sm font-black uppercase tracking-[.18em] text-orange-300">Dartbörse</div><h1 className="mt-2 text-3xl font-black">Meine Angebote</h1><p className="mt-2 text-slate-300">Status verwalten, reservieren, verkaufen oder bearbeiten.</p></div><Button asChild className="rounded-2xl bg-orange-600"><Link href="/dartboerse/neu"><Plus className="mr-2 h-4 w-4"/>Neues Inserat</Link></Button></div></section>
