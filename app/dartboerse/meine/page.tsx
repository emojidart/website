...
export default function MeineDartboersePage(){
 ...
 return <div className="min-h-screen bg-[#f5f6f8] pb-24"><Header/><main className="w-full max-w-none px-2 pb-24 pt-14 sm:px-4 sm:pt-16 lg:px-5 xl:px-6 2xl:px-8"><div className="mb-4"><Button asChild variant="ghost" className="-ml-2 rounded-xl text-slate-600 hover:bg-white hover:text-slate-950"><Link href="/dartboerse"><ArrowLeft className="mr-2 h-4 w-4"/>Zur Dartbörse</Link></Button></div><section className="relative overflow-hidden rounded-[24px] border border-slate-800/10 bg-slate-950 p-4 text-white shadow-[0_24px_80px_-42px_rgba(15,23,42,0.62)] sm:rounded-[28px] sm:p-6 lg:p-8 xl:rounded-[30px]"><div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><div className="text-sm font-black uppercase tracking-[.18em] text-orange-300">Dartbörse</div><h1 className="mt-2 text-3xl font-black">Meine Angebote</h1><p className="mt-2 text-slate-300">Status verwalten, reservieren, verkaufen oder bearbeiten.</p></div><Button asChild className="rounded-2xl bg-orange-500"><Link href="/dartboerse/neu"><Plus className="mr-2 h-4 w-4"/>Neues Inserat</Link></Button></div></section>
