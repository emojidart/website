...
import { MapPin, Phone, Mail, Clock, Navigation, Car, Train, Bus, ExternalLink } from "lucide-react"
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary text-primary-foreground py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Kontakt & Anfahrt</h1>
          <p className="text-lg">Dart & Freizeit Vereinsheim "Pfeil-OK"</p>
        </div>
      </div>
