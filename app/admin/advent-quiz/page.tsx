...
export default function AdminAdventQuizPage() {
  ...
  const getRankBadge = (index: number) => {
    if (index === 0) return { icon: Trophy, color: "bg-yellow-500", text: "🥇 1. Platz" }
    if (index === 1) return { icon: Award, color: "bg-gray-400", text: "🥈 2. Platz" }
    if (index === 2) return { icon: Award, color: "bg-orange-600", text: "🥉 3. Platz" }
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-8">
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Adventskalender Quiz - Auswertung</h1>
              <p className="text-gray-600">Übersicht aller Teilnehmer und ihre Ergebnisse</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">Antworten gesamt</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">Durchschn. Genauigkeit</p>
                  <p className="text-2xl font-bold text-gray-900">
        ...
        <div className="mb-6 flex gap-2">
          ...
          <Button variant={sortBy === "total" ? "default" : "outline"} onClick={() => setSortBy("total")} size="sm">
            Nach richtigen Antworten sortieren
          </Button>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-900">Rangliste</h2>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              <Badge className={`${rank.color} text-white`}>{rank.text}</Badge>
                            </div>
                            <CardTitle className="text-lg mb-1">{participant.player_name}</CardTitle>

                            <div className="grid grid-cols-2 gap-2 text-sm mt-3">
                              <div className="flex items-center gap-1">
                                <CheckCircle className="h-4 w-4 text-green-600" />
                                <span className="font-semibold text-green-600">{participant.correct_answers}</span>
                                <span className="text-gray-600">/ {participant.total_answers} richtig</span>
                              </div>
                              <div className="flex items-center gap-1">
            ...
            {/* Participant Details */}
            <div className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-900">Detailansicht</h2>
              ...
              {selectedParticipant ? (
                <Card>
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div>
                        <CardTitle className="text-xl mb-1">{selectedParticipant.player_name}</CardTitle>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-green-50 p-4 rounded-lg">
                        ...
                        <p className="text-2xl font-bold text-green-600">{selectedParticipant.correct_answers}</p>
                      </div>
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900 mb-3">Antworten pro Tag</h4>
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center">
                                <span className="font-bold text-red-600">{response.day}</span>
                              </div>
                              <div>
                                ...
                                <p className="text-xs text-gray-600">
                                  {new Date(response.answered_at).toLocaleString("de-DE")}
                                </p>
                              </div>
                            </div>
                            <div>
                ...
                <Card>
                  <CardContent className="text-center py-8">
                    ...
                    <p className="text-gray-600">Wählen Sie einen Teilnehmer aus, um Details anzuzeigen.</p>
                  </CardContent>
                </Card>
              )}
            </div>
