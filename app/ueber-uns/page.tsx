          ...
          <motion.div variants={itemVariants} className="mb-4 sm:mb-5">
            <div className="overflow-hidden rounded-[22px] border border-slate-200 bg-white shadow-[0_18px_50px_-42px_rgba(15,23,42,0.55)]">
              ...
              <div className="flex items-start gap-3 p-4 sm:p-5">
                ...
                <div className="min-w-0">
                  <h1 className="text-lg font-black text-slate-950 sm:text-xl">Über uns</h1>
                  <p className="mt-1 text-sm font-medium text-slate-600">EMOJI'S DARTVEREIN – Gemeinschaft, Turniere, Liga und Spaß am Spiel.</p>
                </div>
              </div>
            </div>
          </motion.div>
