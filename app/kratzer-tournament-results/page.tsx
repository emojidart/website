    ...
    <div className="min-h-screen flex flex-col bg-gray-50 text-gray-900 font-sans">
      ...
      <main className="container mx-auto p-4 md:p-6 max-w-7xl flex-grow">
        <h1 className="text-4xl font-extrabold text-center mb-8 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
          Abgeschlossene Kratzer-Turniere
        </h1>

        {loading && (
          <div className="flex flex-col items-center justify-center py-12">
            <Loader2 className="h-16 w-16 animate-spin text-primary-dark" />
            <p className="mt-4 text-gray-700 text-lg font-semibold">Turniere werden geladen...</p>
          </div>
        )}
        ...
        {!loading && !error && tournaments.length === 0 && (
          <div className="text-center py-12 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-600 text-lg">Es wurden noch keine Turniere abgeschlossen.</p>
                ...
                <CardContent className="p-6">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      <AccordionTrigger className="text-lg font-semibold text-primary hover:text-primary-dark">
