  ...
  useEffect(() => {
    const checkGuestAndRedirect = async () => {
      ...
      if (!profileData.is_guest) {
        await supabase.auth.signOut()
        setMessage("Dieses Konto ist kein Gastzugang.")
        return
      }
        ...
        <div className="mx-auto w-full max-w-md">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-2">
              Gastbereich der EMD VereinsApp
            </p>
          </div>
          ...
          <Card className="rounded-3xl shadow-xl border border-gray-200 bg-white">
            <CardContent className="p-6">
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                >
                  {loading ? "Wird geladen…" : "Als Gast anmelden"}
                </Button>
                ...
                <div className="text-center text-sm text-gray-600">
                  ...
                  <Link href="/gastzugang" className="font-bold text-orange-600">
