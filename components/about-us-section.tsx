...
export function AboutUsSection() {
  return (
    <section
      ...
      // Removed initial, whileInView, and variants from the main section
    >
      <div className="max-w-6xl mx-auto">
        <motion.h2
          ...
          initial="hidden" // Keep inner animations
          whileInView="visible"
        ...
        <div
          className="mb-20"
          // Removed initial, whileInView, and variants from this div
        >
        ...
        >
          ...
          <motion.p
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            className="text-center text-lg mt-8 text-brutal-text-muted"
          >
        ...
        >
          ...
          <motion.div
            ...
            variants={sectionVariants} // Keep this for staggered children
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
          >
        ...
        >
          ...
          <motion.p
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            className="text-4xl font-extrabold text-brutal-accent-gold"
          >
            ALS DANN BIS BALD !!!
          </motion.p>
        </div>
